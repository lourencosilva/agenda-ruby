...
class DepartamentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departament" do
    assert_difference('Departament.count') do
      post departaments_url, params: { departament: { description: @departament.description, products_id: @departament.products_id } }
    end
  ...
  test "should update departament" do
    patch departament_url(@departament), params: { departament: { description: @departament.description, products_id: @departament.products_id } }
